 ...
 * Validator.
 */
public abstract class Validator implements IActionInterceptor {
	 ...
	 */
	protected abstract void validate(BaseController c);
	 ...
	 */
	protected abstract void handleError(BaseController c);
	...
	protected void validateRequired(String field, String errorKey, String errorMessage) {
		String value = controller.getParams().get(field);
	...
	protected void validateEqualField(String field_1, String field_2, String errorKey, String errorMessage) {
		String value_1 = controller.getParams().get(field_1);
		String value_2 = controller.getParams().get(field_2);
